...
#     new_model = ModelInfo(
#         model_link="https://huggingface.co/some-model",
#         date_uploaded=datetime.utcnow(),
#         hotkey="unique-hotkey"
#     )
#     persister.add_model(new_model)
#     retrieved_model = persister.get_model(new_model.date_uploaded, new_model.hotkey)
#     print(retrieved_model)
#     persister.delete_model(new_model.date_uploaded, new_model.hotkey)
